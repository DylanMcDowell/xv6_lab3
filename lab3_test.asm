...
int main(int argc, char *argv[]) {
    ...
    1003:	53                   	push   %ebx
    int num = 1;
    1004:	bb 01 00 00 00       	mov    $0x1,%ebx
int main(int argc, char *argv[]) {
    1009:	83 e4 f0             	and    $0xfffffff0,%esp
    100c:	83 ec 10             	sub    $0x10,%esp
    if(argc == 2)
    100f:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
    1013:	0f 84 97 00 00 00    	je     10b0 <main+0xb0>
      num = atoi(argv[1]);
    printf(1, "####################################################\n");
    1019:	c7 44 24 04 b0 18 00 	movl   $0x18b0,0x4(%esp)
    1020:	00 
    1021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1028:	e8 93 04 00 00       	call   14c0 <printf>
    printf(1, "# This program tests the correctness of your lab #3\n");
    102d:	c7 44 24 04 e8 18 00 	movl   $0x18e8,0x4(%esp)
    1034:	00 
    1035:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    103c:	e8 7f 04 00 00       	call   14c0 <printf>
    printf(1, "####################################################\n");
    1041:	c7 44 24 04 b0 18 00 	movl   $0x18b0,0x4(%esp)
    1048:	00 
    1049:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1050:	e8 6b 04 00 00       	call   14c0 <printf>

    printf(1, "Test 1: Simple test\n");
    1055:	c7 44 24 04 7e 18 00 	movl   $0x187e,0x4(%esp)
    105c:	00 
    105d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1064:	e8 57 04 00 00       	call   14c0 <printf>
    int pid = 0;
    pid = fork();
    1069:	e8 ec 02 00 00       	call   135a <fork>
    if(pid == 0){
    106e:	85 c0                	test   %eax,%eax
    1070:	74 39                	je     10ab <main+0xab>
        test(1);
        exit();
    }
    wait();
    1072:	e8 f3 02 00 00       	call   136a <wait>

    printf(1, "Test 2: Stack growth test.\n");
    1077:	c7 44 24 04 93 18 00 	movl   $0x1893,0x4(%esp)
    107e:	00 
    107f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1086:	e8 35 04 00 00       	call   14c0 <printf>
    
    printf(1, "Test 2: trap handled return %d\n", test2(num));
    108b:	89 1c 24             	mov    %ebx,(%esp)
    108e:	e8 4d 00 00 00       	call   10e0 <test2>
    1093:	c7 44 24 04 20 19 00 	movl   $0x1920,0x4(%esp)
    109a:	00 
    109b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a2:	89 44 24 08          	mov    %eax,0x8(%esp)
    10a6:	e8 15 04 00 00       	call   14c0 <printf>
    exit();
    10ab:	e8 b2 02 00 00       	call   1362 <exit>
      num = atoi(argv[1]);
    10b0:	8b 45 0c             	mov    0xc(%ebp),%eax
    10b3:	8b 40 04             	mov    0x4(%eax),%eax
    10b6:	89 04 24             	mov    %eax,(%esp)
    10b9:	e8 42 02 00 00       	call   1300 <atoi>
    10be:	89 c3                	mov    %eax,%ebx
    10c0:	e9 54 ff ff ff       	jmp    1019 <main+0x19>
...
int test2(int n) { 
    ...
    int a[1013] = {0};
    10e5:	b9 f5 03 00 00       	mov    $0x3f5,%ecx
int test2(int n) { 
    10ea:	57                   	push   %edi
    int a[1013] = {0};
    10eb:	8d bd 24 f0 ff ff    	lea    -0xfdc(%ebp),%edi
int test2(int n) { 
    10f1:	81 ec f4 0f 00 00    	sub    $0xff4,%esp
    int a[1013] = {0};
    10f7:	f3 ab                	rep stos %eax,%es:(%edi)
    printf(1, "Test 2: array a is at %p\n", a);
    10f9:	8d 85 24 f0 ff ff    	lea    -0xfdc(%ebp),%eax
    10ff:	89 44 24 08          	mov    %eax,0x8(%esp)
    1103:	c7 44 24 04 64 18 00 	movl   $0x1864,0x4(%esp)
    110a:	00 
    110b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1112:	e8 a9 03 00 00       	call   14c0 <printf>
    1117:	8b 45 08             	mov    0x8(%ebp),%eax
    if(n<2)
    111a:	83 f8 01             	cmp    $0x1,%eax
    111d:	7e 0e                	jle    112d <test2+0x4d>
      return test2(n-1)+1;
    111f:	83 e8 01             	sub    $0x1,%eax
    1122:	89 04 24             	mov    %eax,(%esp)
    1125:	e8 b6 ff ff ff       	call   10e0 <test2>
    112a:	83 c0 01             	add    $0x1,%eax
}
    112d:	81 c4 f4 0f 00 00    	add    $0xff4,%esp
    1133:	5f                   	pop    %edi
    1134:	5d                   	pop    %ebp
    1135:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1459:	0f b6 92 47 19 00 00 	movzbl 0x1947(%edx),%edx
  }while((x /= base) != 0);
    ...
    14ce:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    15ef:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    15f1:	b8 40 19 00 00       	mov    $0x1940,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    16b1:	a1 40 1c 00 00       	mov    0x1c40,%eax
{
  ...
  freep = p;
    16f9:	a3 40 1c 00 00       	mov    %eax,0x1c40
}
    16fe:	5b                   	pop    %ebx
    16ff:	5e                   	pop    %esi
    1700:	5f                   	pop    %edi
  ...
  freep = p;
    1722:	a3 40 1c 00 00       	mov    %eax,0x1c40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    174c:	8b 1d 40 1c 00 00    	mov    0x1c40,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    178b:	3b 15 40 1c 00 00    	cmp    0x1c40,%edx
  ...
  return freep;
    17c2:	8b 15 40 1c 00 00    	mov    0x1c40,%edx
    ...
    17e4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    17e7:	89 15 40 1c 00 00    	mov    %edx,0x1c40
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    17fe:	c7 05 40 1c 00 00 44 	movl   $0x1c44,0x1c40
    1805:	1c 00 00 
    base.s.size = 0;
    1808:	ba 44 1c 00 00       	mov    $0x1c44,%edx
    base.s.ptr = freep = prevp = &base;
    180d:	c7 05 44 1c 00 00 44 	movl   $0x1c44,0x1c44
    1814:	1c 00 00 
    base.s.size = 0;
    1817:	c7 05 48 1c 00 00 00 	movl   $0x0,0x1c48
    181e:	00 00 00 
