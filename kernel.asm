...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 bf 76 10 80 	movl   $0x801076bf,(%esp)
...
80100b70:	e8 7b 5d 00 00       	call   801068f0 <freevm>
  return -1;
...
80100b7f:	e8 fc 1f 00 00       	call   80102b80 <end_op>
    cprintf("exec: fail\n");
80100b84:	c7 04 24 c1 6d 10 80 	movl   $0x80106dc1,(%esp)
...
80100bab:	e8 70 5e 00 00       	call   80106a20 <clearpteu>
...
80100c19:	e8 12 60 00 00       	call   80106c30 <copyout>
...
80100c86:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c8c:	e8 9f 5f 00 00       	call   80106c30 <copyout>
...
80100d18:	e8 53 58 00 00       	call   80106570 <switchuvm>
  freevm(oldpgdir);
80100d1d:	89 34 24             	mov    %esi,(%esp)
80100d20:	e8 cb 5b 00 00       	call   801068f0 <freevm>
  return 0;
...
80100ec7:	e9 b4 1c 00 00       	jmp    80102b80 <end_op>
    panic("fileclose");
80100ecc:	c7 04 24 dc 6d 10 80 	movl   $0x80106ddc,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  panic("fileread");
80100fb7:	c7 04 24 e6 6d 10 80 	movl   $0x80106de6,(%esp)
...
801010cc:	e9 1f 22 00 00       	jmp    801032f0 <pipewrite>
        panic("short filewrite");
801010d1:	c7 04 24 ef 6d 10 80 	movl   $0x80106def,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010dd:	c7 04 24 f5 6d 10 80 	movl   $0x80106df5,(%esp)
...
80101195:	c7 04 24 ff 6d 10 80 	movl   $0x80106dff,(%esp)
...
801012bd:	c7 04 24 15 6e 10 80 	movl   $0x80106e15,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  panic("bmap: out of range");
80101377:	c7 04 24 25 6e 10 80 	movl   $0x80106e25,(%esp)
...
80101459:	c7 04 24 38 6e 10 80 	movl   $0x80106e38,(%esp)
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 a6 74 10 80 	movl   $0x801074a6,(%esp)
...
80102da7:	e8 e4 26 00 00       	call   80105490 <idtinit>
...
80102dd6:	e8 75 37 00 00       	call   80106550 <switchkvm>
  seginit();
80102ddb:	e8 30 36 00 00       	call   80106410 <seginit>
  lapicinit();
...
80102e25:	e8 e6 35 00 00       	call   80106410 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 71 29 00 00       	call   801057b0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  shminit();       // shared memory
80102e45:	e8 76 3e 00 00       	call   80106cc0 <shminit>
  tvinit();        // trap vectors
80102e4a:	e8 a1 25 00 00       	call   801053f0 <tvinit>
80102e4f:	90                   	nop
  binit();         // buffer cache
...
8010352d:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 e5 53 10 80 	movl   $0x801053e5,0x14(%eax)
...
801035e6:	c7 44 24 04 95 72 10 	movl   $0x80107295,0x4(%esp)
801035ed:	80 
...
8010365a:	c7 04 24 9c 72 10 80 	movl   $0x8010729c,(%esp)
80103661:	e8 fa cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 78 73 10 80 	movl   $0x80107378,(%esp)
...
80103782:	00 
80103783:	c7 44 24 04 c5 72 10 	movl   $0x801072c5,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 cd 0c 00 00       	call   80104460 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 ce 72 10 80 	movl   $0x801072ce,(%esp)
...
801037c7:	c7 04 24 ac 72 10 80 	movl   $0x801072ac,(%esp)
...
80103809:	e8 c2 2f 00 00       	call   801067d0 <allocuvm>
...
80103a6e:	c7 04 24 d0 72 10 80 	movl   $0x801072d0,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 fc 72 10 80 	movl   $0x801072fc,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 ee 72 10 80 	movl   $0x801072ee,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 e2 72 10 80 	movl   $0x801072e2,(%esp)
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 1d 73 10 80 	movl   $0x8010731d,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 10 73 10 80 	movl   $0x80107310,(%esp)
...
80103c8e:	c7 04 24 2f 73 10 80 	movl   $0x8010732f,(%esp)
80103c95:	e8 c6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c9a:	c7 04 24 29 73 10 80 	movl   $0x80107329,(%esp)
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 bf 76 10 80 	movl   $0x801076bf,(%esp)
...
80103eaa:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ead:	ba 40 73 10 80       	mov    $0x80107340,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103eb2:	77 11                	ja     80103ec5 <procdump+0x55>
80103eb4:	8b 14 85 a0 73 10 80 	mov    -0x7fef8c60(,%eax,4),%edx
      state = "???";
80103ebb:	b8 40 73 10 80       	mov    $0x80107340,%eax
...
80103ed0:	c7 04 24 44 73 10 80 	movl   $0x80107344,(%esp)
...
80103f19:	c7 04 24 81 6d 10 80 	movl   $0x80106d81,(%esp)
...
80103f4a:	c7 44 24 04 b8 73 10 	movl   $0x801073b8,0x4(%esp)
80103f51:	80 
...
801041a7:	eb ac                	jmp    80104155 <acquire+0x15>
    panic("acquire");
801041a9:	c7 04 24 c3 73 10 80 	movl   $0x801073c3,(%esp)
...
80104209:	c3                   	ret    
    panic("popcli");
8010420a:	c7 04 24 e2 73 10 80 	movl   $0x801073e2,(%esp)
80104211:	e8 4a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104216:	c7 04 24 cb 73 10 80 	movl   $0x801073cb,(%esp)
...
8010423f:	75 0f                	jne    80104250 <release+0x20>
    panic("release");
80104241:	c7 04 24 e9 73 10 80 	movl   $0x801073e9,(%esp)
...
801044fa:	e8 a1 f1 ff ff       	call   801036a0 <myproc>
  ...
  //if(addr >= curproc->sz)
    //return -1;
  *pp = (char*)addr;
801044ff:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104502:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80104504:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
80104506:	39 c3                	cmp    %eax,%ebx
80104508:	73 1a                	jae    80104524 <fetchstr+0x34>
    if(*s == 0)
8010450a:	80 3b 00             	cmpb   $0x0,(%ebx)
8010450d:	89 da                	mov    %ebx,%edx
8010450f:	75 0c                	jne    8010451d <fetchstr+0x2d>
80104511:	eb 1d                	jmp    80104530 <fetchstr+0x40>
80104513:	90                   	nop
80104514:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104518:	80 3a 00             	cmpb   $0x0,(%edx)
8010451b:	74 13                	je     80104530 <fetchstr+0x40>
  for(s = *pp; s < ep; s++){
8010451d:	83 c2 01             	add    $0x1,%edx
80104520:	39 d0                	cmp    %edx,%eax
80104522:	77 f4                	ja     80104518 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
80104524:	83 c4 04             	add    $0x4,%esp
  return -1;
...
80104546:	e8 55 f1 ff ff       	call   801036a0 <myproc>
  *ip = *(int*)(addr);
...
801045a8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801045ab:	e8 f0 f0 ff ff       	call   801036a0 <myproc>
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
801045b0:	89 75 0c             	mov    %esi,0xc(%ebp)
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801045b3:	8b 40 1c             	mov    0x1c(%eax),%eax
  *ip = *(int*)(addr);
801045b6:	8b 40 44             	mov    0x44(%eax),%eax
  return fetchstr(addr, pp);
801045b9:	8b 44 98 04          	mov    0x4(%eax,%ebx,4),%eax
}
801045bd:	5b                   	pop    %ebx
801045be:	5e                   	pop    %esi
  return fetchstr(addr, pp);
801045bf:	89 45 08             	mov    %eax,0x8(%ebp)
}
801045c2:	5d                   	pop    %ebp
  return fetchstr(addr, pp);
801045c3:	e9 28 ff ff ff       	jmp    801044f0 <fetchstr>
801045c8:	90                   	nop
...
801045d5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801045d8:	e8 c3 f0 ff ff       	call   801036a0 <myproc>

  num = curproc->tf->eax;
801045dd:	8b 70 1c             	mov    0x1c(%eax),%esi
  struct proc *curproc = myproc();
...
801045ed:	8b 14 85 20 74 10 80 	mov    -0x7fef8be0(,%eax,4),%edx
...
80104608:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
8010460c:	8d 43 70             	lea    0x70(%ebx),%eax
8010460f:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
80104613:	8b 43 14             	mov    0x14(%ebx),%eax
80104616:	c7 04 24 f1 73 10 80 	movl   $0x801073f1,(%esp)
8010461d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104621:	e8 2a c0 ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
80104626:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104646:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104649:	e8 52 f0 ff ff       	call   801036a0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
8010464e:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80104650:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
8010466c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104670:	89 5c 90 2c          	mov    %ebx,0x2c(%eax,%edx,4)
}
...
8010469c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010469f:	e8 7c d8 ff ff       	call   80101f20 <nameiparent>
...
801046b1:	e8 fa cf ff ff       	call   801016b0 <ilock>
...
801046fb:	e8 10 d2 ff ff       	call   80101910 <iunlockput>
}
...
8010471d:	e8 fe cd ff ff       	call   80101520 <ialloc>
...
8010472f:	e8 7c cf ff ff       	call   801016b0 <ilock>
  ip->major = major;
...
80104750:	e8 9b ce ff ff       	call   801015f0 <iupdate>
...
8010481a:	e8 21 fd ff ff       	call   80104540 <argint>
...
80104829:	e8 72 ee ff ff       	call   801036a0 <myproc>
8010482e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104831:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104899:	e8 32 c5 ff ff       	call   80100dd0 <filedup>
  return fd;
...
801048d2:	e8 69 fc ff ff       	call   80104540 <argint>
...
801048f0:	e8 7b fc ff ff       	call   80104570 <argptr>
...
8010490d:	e8 1e c6 ff ff       	call   80100f30 <fileread>
}
80104912:	c9                   	leave  
80104913:	c3                   	ret    
...
80104942:	e8 f9 fb ff ff       	call   80104540 <argint>
...
80104960:	e8 0b fc ff ff       	call   80104570 <argptr>
...
8010497d:	e8 4e c6 ff ff       	call   80100fd0 <filewrite>
}
80104982:	c9                   	leave  
80104983:	c3                   	ret    
...
801049a3:	78 23                	js     801049c8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
801049a5:	e8 f6 ec ff ff       	call   801036a0 <myproc>
801049aa:	8b 55 f0             	mov    -0x10(%ebp),%edx
801049ad:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
801049b4:	00 
  fileclose(f);
801049b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049b8:	89 04 24             	mov    %eax,(%esp)
801049bb:	e8 60 c4 ff ff       	call   80100e20 <fileclose>
  return 0;
...
801049fa:	e8 71 fb ff ff       	call   80104570 <argptr>
...
80104a10:	e8 cb c4 ff ff       	call   80100ee0 <filestat>
}
80104a15:	c9                   	leave  
80104a16:	c3                   	ret    
80104a17:	90                   	nop
...
80104a37:	e8 64 fb ff ff       	call   801045a0 <argstr>
...
80104a7c:	e8 2f cc ff ff       	call   801016b0 <ilock>
  if(ip->type == T_DIR){
...
80104a97:	e8 54 cb ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104a9c:	89 1c 24             	mov    %ebx,(%esp)
80104a9f:	e8 ec cc ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104aa4:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104aa7:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104aab:	89 04 24             	mov    %eax,(%esp)
80104aae:	e8 6d d4 ff ff       	call   80101f20 <nameiparent>
...
80104abc:	e8 ef cb ff ff       	call   801016b0 <ilock>
...
80104ad5:	e8 46 d3 ff ff       	call   80101e20 <dirlink>
80104ada:	85 c0                	test   %eax,%eax
80104adc:	78 22                	js     80104b00 <sys_link+0xe0>
  iunlockput(dp);
80104ade:	89 34 24             	mov    %esi,(%esp)
80104ae1:	e8 2a ce ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104ae6:	89 1c 24             	mov    %ebx,(%esp)
80104ae9:	e8 e2 cc ff ff       	call   801017d0 <iput>
  end_op();
80104aee:	e8 8d e0 ff ff       	call   80102b80 <end_op>
}
...
80104b03:	e8 08 ce ff ff       	call   80101910 <iunlockput>
  ilock(ip);
80104b08:	89 1c 24             	mov    %ebx,(%esp)
80104b0b:	e8 a0 cb ff ff       	call   801016b0 <ilock>
  ip->nlink--;
...
80104b20:	e8 eb cd ff ff       	call   80101910 <iunlockput>
  end_op();
80104b25:	e8 56 e0 ff ff       	call   80102b80 <end_op>
}
...
80104b57:	e8 44 fa ff ff       	call   801045a0 <argstr>
80104b5c:	85 c0                	test   %eax,%eax
80104b5e:	0f 88 76 01 00 00    	js     80104cda <sys_unlink+0x19a>
  begin_op();
80104b64:	e8 a7 df ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104b76:	e8 a5 d3 ff ff       	call   80101f20 <nameiparent>
...
80104b91:	c7 44 24 04 9c 74 10 	movl   $0x8010749c,0x4(%esp)
80104b98:	80 
80104b99:	89 1c 24             	mov    %ebx,(%esp)
80104b9c:	e8 ef cf ff ff       	call   80101b90 <namecmp>
80104ba1:	85 c0                	test   %eax,%eax
80104ba3:	0f 84 21 01 00 00    	je     80104cca <sys_unlink+0x18a>
80104ba9:	c7 44 24 04 9b 74 10 	movl   $0x8010749b,0x4(%esp)
80104bb0:	80 
80104bb1:	89 1c 24             	mov    %ebx,(%esp)
80104bb4:	e8 d7 cf ff ff       	call   80101b90 <namecmp>
...
80104bcf:	e8 ec cf ff ff       	call   80101bc0 <dirlookup>
...
80104be1:	e8 ca ca ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
...
80104c0e:	e8 6d f6 ff ff       	call   80104280 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104c2c:	e8 2f ce ff ff       	call   80101a60 <writei>
...
80104c4b:	e8 c0 cc ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
...
80104c60:	e8 ab cc ff ff       	call   80101910 <iunlockput>
  end_op();
80104c65:	e8 16 df ff ff       	call   80102b80 <end_op>
}
...
80104cb1:	e8 aa cc ff ff       	call   80101960 <readi>
...
80104cc5:	e8 46 cc ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
...
80104cf3:	e8 f8 c8 ff ff       	call   801015f0 <iupdate>
80104cf8:	e9 48 ff ff ff       	jmp    80104c45 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104cfd:	c7 04 24 c0 74 10 80 	movl   $0x801074c0,(%esp)
80104d04:	e8 57 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d09:	c7 04 24 d2 74 10 80 	movl   $0x801074d2,(%esp)
80104d10:	e8 4b b6 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d15:	c7 04 24 ae 74 10 80 	movl   $0x801074ae,(%esp)
...
80104d47:	e8 54 f8 ff ff       	call   801045a0 <argstr>
...
80104d62:	e8 d9 f7 ff ff       	call   80104540 <argint>
80104d67:	85 c0                	test   %eax,%eax
80104d69:	0f 88 b6 00 00 00    	js     80104e25 <sys_open+0xf5>
    return -1;

  begin_op();
80104d6f:	e8 9c dd ff ff       	call   80102b10 <begin_op>
...
80104d84:	e8 77 d1 ff ff       	call   80101f00 <namei>
...
80104d96:	e8 15 c9 ff ff       	call   801016b0 <ilock>
...
80104da6:	e8 b5 bf ff ff       	call   80100d60 <filealloc>
...
80104dc7:	e8 c4 c9 ff ff       	call   80101790 <iunlock>
  end_op();
80104dcc:	e8 af dd ff ff       	call   80102b80 <end_op>
...
80104e1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80104e20:	e8 5b dd ff ff       	call   80102b80 <end_op>
}
...
80104e5b:	e8 c0 bf ff ff       	call   80100e20 <fileclose>
...
80104eaf:	e8 5c ca ff ff       	call   80101910 <iunlockput>
  end_op();
80104eb4:	e8 c7 dc ff ff       	call   80102b80 <end_op>
  return 0;
...
80104f00:	e8 3b f6 ff ff       	call   80104540 <argint>
  if((argstr(0, &path)) < 0 ||
...
80104f17:	e8 24 f6 ff ff       	call   80104540 <argint>
     argint(1, &major) < 0 ||
...
80104f65:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80104f68:	e8 33 e7 ff ff       	call   801036a0 <myproc>
...
80104f82:	e8 19 f6 ff ff       	call   801045a0 <argstr>
...
80104f91:	e8 6a cf ff ff       	call   80101f00 <namei>
...
80104f9f:	e8 0c c7 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
80104fac:	75 22                	jne    80104fd0 <sys_chdir+0x70>
  ...
  iunlock(ip);
80104fae:	e8 dd c7 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80104fb3:	8b 46 6c             	mov    0x6c(%esi),%eax
80104fb6:	89 04 24             	mov    %eax,(%esp)
80104fb9:	e8 12 c8 ff ff       	call   801017d0 <iput>
  end_op();
80104fbe:	e8 bd db ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
80104fc3:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80104fc5:	89 5e 6c             	mov    %ebx,0x6c(%esi)
}
...
8010500d:	e8 8e f5 ff ff       	call   801045a0 <argstr>
...
8010502b:	e8 10 f5 ff ff       	call   80104540 <argint>
...
8010505b:	e8 20 f2 ff ff       	call   80104280 <memset>
    if(i >= NELEM(argv))
      return -1;
...
80105070:	e8 5b f4 ff ff       	call   801044d0 <fetchint>
...
8010508a:	e8 61 f4 ff ff       	call   801044f0 <fetchstr>
...
801050fd:	e8 6e f4 ff ff       	call   80104570 <argptr>
...
80105113:	e8 58 e0 ff ff       	call   80103170 <pipealloc>
...
80105149:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105150:	e8 4b e5 ff ff       	call   801036a0 <myproc>
80105155:	c7 44 98 2c 00 00 00 	movl   $0x0,0x2c(%eax,%ebx,4)
8010515c:	00 
    fileclose(rf);
8010515d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105160:	89 04 24             	mov    %eax,(%esp)
80105163:	e8 b8 bc ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
80105168:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010516b:	89 04 24             	mov    %eax,(%esp)
8010516e:	e8 ad bc ff ff       	call   80100e20 <fileclose>
}
...
80105194:	e8 a7 f3 ff ff       	call   80104540 <argint>
...
801051b3:	e8 b8 f3 ff ff       	call   80104570 <argptr>
...
801051c9:	e8 52 1b 00 00       	call   80106d20 <shm_open>
}
801051ce:	c9                   	leave  
801051cf:	c3                   	ret    
    return -1;
...
80105203:	e8 28 1b 00 00       	call   80106d30 <shm_close>
}
80105208:	c9                   	leave  
80105209:	c3                   	ret    
...
80105264:	e8 d7 f2 ff ff       	call   80104540 <argint>
...
8010529b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010529e:	c9                   	leave  
8010529f:	c3                   	ret    
...
801052b5:	e8 86 f2 ff ff       	call   80104540 <argint>
...
80105355:	8b 40 28             	mov    0x28(%eax),%eax
...
80105449:	c7 44 24 04 e1 74 10 	movl   $0x801074e1,0x4(%esp)
80105450:	80 
...
80105476:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010547c:	e8 cf eb ff ff       	call   80104050 <initlock>
}
80105481:	c9                   	leave  
80105482:	c3                   	ret    
...
801054e0:	ff 24 85 88 75 10 80 	jmp    *-0x7fef8a78(,%eax,4)
801054e7:	90                   	nop
    lapiceoi();
    break;
...
801054e8:	e8 b3 e1 ff ff       	call   801036a0 <myproc>
...
8010550c:	e8 6f e1 ff ff       	call   80103680 <cpuid>
...
8010551c:	e8 7f e1 ff ff       	call   801036a0 <myproc>
80105521:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105524:	e8 77 e1 ff ff       	call   801036a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
8010553e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80105541:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105550:	8b 40 14             	mov    0x14(%eax),%eax
80105553:	c7 04 24 44 75 10 80 	movl   $0x80107544,(%esp)
8010555a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010555e:	e8 ed b0 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105563:	e8 38 e1 ff ff       	call   801036a0 <myproc>
80105568:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
8010556f:	90                   	nop
  }
...
80105570:	e8 2b e1 ff ff       	call   801036a0 <myproc>
80105575:	85 c0                	test   %eax,%eax
80105577:	74 0c                	je     80105585 <trap+0xc5>
80105579:	e8 22 e1 ff ff       	call   801036a0 <myproc>
8010557e:	8b 50 28             	mov    0x28(%eax),%edx
...
80105585:	e8 16 e1 ff ff       	call   801036a0 <myproc>
...
80105595:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
801055db:	75 a8                	jne    80105585 <trap+0xc5>
    exit();
801055dd:	e8 be e4 ff ff       	call   80103aa0 <exit>
...
80105647:	e8 34 e0 ff ff       	call   80103680 <cpuid>
8010564c:	c7 04 24 ec 74 10 80 	movl   $0x801074ec,(%esp)
...
8010565f:	e8 ec af ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105664:	e8 17 d1 ff ff       	call   80102780 <lapiceoi>
    break;
80105669:	e9 02 ff ff ff       	jmp    80105570 <trap+0xb0>
8010566e:	66 90                	xchg   %ax,%ax
    ideintr();
80105670:	e8 0b ca ff ff       	call   80102080 <ideintr>
...
8010570a:	c7 04 24 10 75 10 80 	movl   $0x80107510,(%esp)
80105711:	89 44 24 04          	mov    %eax,0x4(%esp)
80105715:	e8 36 af ff ff       	call   80100650 <cprintf>
      panic("trap");
8010571a:	c7 04 24 e6 74 10 80 	movl   $0x801074e6,(%esp)
...
80105787:	e8 14 d0 ff ff       	call   801027a0 <microdelay>
...
80105817:	00 
  for(p="xv6...\n"; *p; p++)
80105818:	bb 08 76 10 80       	mov    $0x80107608,%ebx
  ioapicenable(IRQ_COM1, 0);
8010581d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105824:	e8 87 ca ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80106324:	e8 77 c1 ff ff       	call   801024a0 <kalloc>
...
801063b3:	e8 38 bf ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
801063fa:	c3                   	ret    
        panic("kfree");
801063fb:	c7 04 24 a6 6f 10 80 	movl   $0x80106fa6,(%esp)
...
80106413:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106416:	e8 65 d2 ff ff       	call   80103680 <cpuid>
...
80106541:	c3                   	ret    
      panic("remap");
80106542:	c7 04 24 10 76 10 80 	movl   $0x80107610,(%esp)
...
801065fe:	e8 fd cf ff ff       	call   80103600 <mycpu>
80106603:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010660a:	e8 f1 cf ff ff       	call   80103600 <mycpu>
...
8010661d:	8b 56 0c             	mov    0xc(%esi),%edx
...
8010663a:	8b 46 08             	mov    0x8(%esi),%eax
...
80106651:	c7 04 24 16 76 10 80 	movl   $0x80107616,(%esp)
80106658:	e8 03 9d ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010665d:	c7 04 24 41 76 10 80 	movl   $0x80107641,(%esp)
80106664:	e8 f7 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106669:	c7 04 24 2c 76 10 80 	movl   $0x8010762c,(%esp)
...
8010669a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
8010669d:	e8 fe bd ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801066f8:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801066f9:	e9 22 dc ff ff       	jmp    80104320 <memmove>
    panic("inituvm: more than a page");
801066fe:	c7 04 24 55 76 10 80 	movl   $0x80107655,(%esp)
...
8010678d:	e8 ce b1 ff ff       	call   80101960 <readi>
...
801067b2:	c7 04 24 6f 76 10 80 	movl   $0x8010766f,(%esp)
801067b9:	e8 a2 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801067be:	c7 04 24 10 77 10 80 	movl   $0x80107710,(%esp)
...
8010681b:	e8 60 da ff ff       	call   80104280 <memset>
...
80106855:	76 29                	jbe    80106880 <allocuvm+0xb0>
    mem = kalloc();
80106857:	e8 44 bc ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
80106862:	c7 04 24 8d 76 10 80 	movl   $0x8010768d,(%esp)
...
80106890:	c7 04 24 a5 76 10 80 	movl   $0x801076a5,(%esp)
...
80106953:	e9 98 b9 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106958:	c7 04 24 c1 76 10 80 	movl   $0x801076c1,(%esp)
...
80106a3b:	c3                   	ret    
    panic("clearpteu");
80106a3c:	c7 04 24 d2 76 10 80 	movl   $0x801076d2,(%esp)
...
80106a63:	0f 84 67 01 00 00    	je     80106bd0 <copyuvm+0x180>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106ad7:	0f 84 06 01 00 00    	je     80106be3 <copyuvm+0x193>
    if(!(*pte & PTE_P))
80106add:	8b 30                	mov    (%eax),%esi
80106adf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106ae5:	0f 84 ec 00 00 00    	je     80106bd7 <copyuvm+0x187>
    pa = PTE_ADDR(*pte);
...
80106af6:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106afc:	e8 9f b9 ff ff       	call   801024a0 <kalloc>
...
80106b20:	8b 5d 10             	mov    0x10(%ebp),%ebx
80106b23:	f7 db                	neg    %ebx
80106b25:	c1 e3 0c             	shl    $0xc,%ebx
80106b28:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80106b2e:	79 56                	jns    80106b86 <copyuvm+0x136>
80106b30:	e9 90 00 00 00       	jmp    80106bc5 <copyuvm+0x175>
...
80106b75:	e8 56 f9 ff ff       	call   801064d0 <mappages>
80106b7a:	85 c0                	test   %eax,%eax
80106b7c:	78 8d                	js     80106b0b <copyuvm+0xbb>
  for(i = KERNBASE - (ssz*PGSIZE); i < KERNBASE; i += PGSIZE){
80106b7e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b84:	78 3f                	js     80106bc5 <copyuvm+0x175>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106b86:	8b 45 08             	mov    0x8(%ebp),%eax
80106b89:	31 c9                	xor    %ecx,%ecx
80106b8b:	89 da                	mov    %ebx,%edx
80106b8d:	e8 4e f7 ff ff       	call   801062e0 <walkpgdir>
80106b92:	85 c0                	test   %eax,%eax
80106b94:	74 4d                	je     80106be3 <copyuvm+0x193>
    if(!(*pte & PTE_P))
80106b96:	8b 30                	mov    (%eax),%esi
80106b98:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b9e:	74 37                	je     80106bd7 <copyuvm+0x187>
    pa = PTE_ADDR(*pte);
80106ba0:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106ba2:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106ba8:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106bab:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106bb1:	e8 ea b8 ff ff       	call   801024a0 <kalloc>
80106bb6:	85 c0                	test   %eax,%eax
80106bb8:	89 c6                	mov    %eax,%esi
80106bba:	0f 85 78 ff ff ff    	jne    80106b38 <copyuvm+0xe8>
80106bc0:	e9 46 ff ff ff       	jmp    80106b0b <copyuvm+0xbb>
...
80106bd2:	e9 41 ff ff ff       	jmp    80106b18 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106bd7:	c7 04 24 f6 76 10 80 	movl   $0x801076f6,(%esp)
80106bde:	e8 7d 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106be3:	c7 04 24 dc 76 10 80 	movl   $0x801076dc,(%esp)
...
80106bfe:	e8 dd f6 ff ff       	call   801062e0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106c6c:	e8 af d6 ff ff       	call   80104320 <memmove>
    len -= n;
    buf += n;
...
80106cc6:	c7 44 24 04 34 77 10 	movl   $0x80107734,0x4(%esp)
80106ccd:	80 
80106cce:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106cd5:	e8 76 d3 ff ff       	call   80104050 <initlock>
  acquire(&(shm_table.lock));
80106cda:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106ce1:	e8 5a d4 ff ff       	call   80104140 <acquire>
80106ce6:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106ceb:	90                   	nop
80106cec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i< 64; i++) {
    shm_table.shm_pages[i].id =0;
80106cf0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106cf6:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].frame =0;
80106cf9:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    shm_table.shm_pages[i].refcnt =0;
80106d00:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
80106d07:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106d0c:	75 e2                	jne    80106cf0 <shminit+0x30>
  }
  release(&(shm_table.lock));
80106d0e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d15:	e8 16 d5 ff ff       	call   80104230 <release>
}
80106d1a:	c9                   	leave  
80106d1b:	c3                   	ret    
